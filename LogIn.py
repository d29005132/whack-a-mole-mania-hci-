...
class Ui_LogIn(object):
    def setupUi(self, LogIn):
        ...
        self.label_picture.setStyleSheet("border-image:url(zzf.jpg)")
    ...
    def retranslateUi(self, LogIn):
        ...
        LogIn.setWindowTitle(_translate("LogIn", "刺激打地鼠"))
        self.pushButton_start.setText(_translate("LogIn", "開玩"))
        self.pushButton_pause.setText(_translate("LogIn", "暫停"))
        self.pushButton_stop.setText(_translate("LogIn", "停止"))
        self.label.setText(_translate("LogIn", "TIME"))
        self.label_2.setText(_translate("LogIn", "SCORE"))
